...
export function cloneJsDocOverloadTag(node: Mutable<TS.JSDocOverloadTag>, options: CloneNodeVisitorOptions<TS.JSDocOverloadTag>): TS.JSDocOverloadTag {
	const baseNode = options.factory.createJSDocOverloadTag(
	...
	) as Mutable<TS.JSDocOverloadTag>;
